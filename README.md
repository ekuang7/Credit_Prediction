...
**Notes**
  ...
  Must npm to get the dependencies and run the flask script first before running the node app. Also, you will need to create .env file with your own email configurations to automatically    send emails after the model predicts approved or declined. 
